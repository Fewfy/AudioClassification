"""Confiuration of the project."""

import os

root = "/media/fy/DATA/GraduationProject/AudioClassification/Resource"
audio_dir = "audio"
label_dir = "label"
label_location = '/media/fy/DATA/dataset/ESC-50/meta/esc50.csv'
...
video_ext = [".mp4"]
video_file = os.path.join(video_root, "0za00IG90gs.mp4")
num_frames = 300
batch_size = 32

# config for Inception v3
save_step = 10000
...
extract_feat_path = os.path.join(root, "extracted_feats", "train-{:0004}.tfrecord")
feats_per_file = 300
